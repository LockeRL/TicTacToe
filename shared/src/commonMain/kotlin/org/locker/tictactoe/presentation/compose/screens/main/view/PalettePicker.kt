...
import org.locker.tictactoe.presentation.theme.AppColors1
import org.locker.tictactoe.presentation.theme.AppColors2
import org.locker.tictactoe.presentation.theme.PALETTE_SLIDE_ANIM_DURATION
import org.locker.tictactoe.presentation.theme.Size32
import org.locker.tictactoe.presentation.theme.Size48
import org.locker.tictactoe.presentation.theme.Space2
import org.locker.tictactoe.presentation.theme.TicTacToeTheme
import org.locker.tictactoe.presentation.theme.VERY_LOW_STIFFNESS
import kotlinx.coroutines.flow.MutableStateFlow
import kotlinx.coroutines.flow.StateFlow
import org.jetbrains.compose.resources.stringResource
import org.koin.compose.koinInject
import tictactoe.shared.generated.resources.Res
import tictactoe.shared.generated.resources.colors_slider_animate_padding
import tictactoe.shared.generated.resources.ic_palette
...
fun PalettePicker(
    ...
    val slideInPadding by animateDpAsState(
        ...
        label = stringResource(Res.string.colors_slider_animate_padding),
    ...
    Box(
        ...
        TicTacToeIconButton(
            ...
            contentDescription = stringResource(Res.string.ic_palette),
            containerColor = if (isExpanded) themeColors.primary else themeColors.background,
            contentColor = if (isExpanded) themeColors.background else themeColors.secondaryContainer,
            modifier = Modifier
                .size(Size48)
                .align(Alignment.CenterEnd),
